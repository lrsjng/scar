const {is_fn, as_fn, run_seq, run_conc} = require('./util');
...
class Suite {
    ...
    run_test(test) {
        return Promise.resolve()
            .then(() => this.reporter && is_fn(this.reporter.before_test) && this.reporter.before_test(this, test))
            .then(() => {
                this.run_count += 1;
            ...
            .then(() => this.reporter && is_fn(this.reporter.after_test) && this.reporter.after_test(this, test));
    }
    ...
    run() {
        this.promise = this.promise || Promise.resolve()
            ...
            .then(() => this.reporter && is_fn(this.reporter.before_all) && this.reporter.before_all(this))
            .then(() => {
            ...
            .then(() => this.reporter && is_fn(this.reporter.after_all) && this.reporter.after_all(this))
            .then(() => this);
